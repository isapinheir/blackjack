...
Um jogo interativo desenvolvido em JavaScript para aplicar e consolidar os conceitos fundamentais da linguagem.
...
### 3. Manipulação de Arrays (Vetores)
...
### 5. Geração de Números Aleatórios (Objeto `Math`)
